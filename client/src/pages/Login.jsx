      ...
      <div className="login-right" style={{ flex: '0 0 45%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', background: '#050505' }}>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Forgot Password */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '-0.5rem', marginBottom: '2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <input type="checkbox" id="remember" style={{ accentColor: '#10b981' }} />
                <label htmlFor="remember" style={{ color: '#9ca3af', fontSize: '0.85rem', cursor: 'pointer' }}>Remember me</label>
              </div>
              <a href="#" style={{ color: '#10b981', fontSize: '0.85rem', fontWeight: 500, textDecoration: 'none' }}>
                Forgot password?
              </a>
            </div>
          ...
          <div style={{ marginTop: '2.5rem', textAlign: 'center', fontSize: '0.9rem', color: '#9ca3af' }}>
            ...
            <Link to="/register" style={{ color: '#ffffff', fontWeight: 500, textDecoration: 'none' }} onMouseEnter={e => e.target.style.textDecoration = 'underline'} onMouseLeave={e => e.target.style.textDecoration = 'none'}>
              Sign up
            </Link>
          </div>
        </motion.div>
